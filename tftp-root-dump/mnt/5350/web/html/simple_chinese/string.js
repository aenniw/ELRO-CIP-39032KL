...
var str_osd_list2='黄色';
var str_osd_list3='红色';
var str_osd_list4='白色';
var str_osd_list5='蓝色';
var str_reversal='图像翻转';
var str_mirror='图像镜像';
var str_pathset='路径设置';
var str_record_path='录像路径';
var str_browse='浏览...';
var str_RECPathfailC="设置失败,不能将系统目录设为录像路径!";
var str_RECPathSuccess="设置录像路径成功";
var str_SetTrustedSites="请将设备IP设为IE的受信任的站点"+"\n"+" '受信任站点'路径: IE浏览器->工具->Internet选项->安全->受信任的站点->站点->添加";
var str_RECPathFail="设置录像路径失败";
var str_save="保存";
var str_anonymous='佚名';
var str_mode_activex='ActiveX 模式(适用于 IE 浏览器)';
var str_mode_serverpush='Server Push 模式(适用于 Safari、FireFox、Google 浏览器)';
var str_mode_vlc="VLC 模式(适用于 Safari, FireFox, Google 浏览器)";
var str_user='用户';
var str_pwd='密码';
var str_signin='登  录';
var str_attention='注:';
...
var str_lowest='最低';
var str_login_mobile='登录手机页面';
var str_wifi_mode_list='<option>访问点</option><option>点到点</option>';
var str_smtp_port='SMTP 端口';
var str_ddns_service_list='<option value=0>无</option><option value=1>花生壳</option><option value=2>DynDns.org(dyndns)</option><option value=3>DynDns.org(statdns)</option><option value=4>DynDns.org(custom)</option><option value=8>3322.org(dyndns)</option><option value=9>3322.org(statdns)</option>';
...
var str_alarm_record_path='报警录像路径';
var str_AlarmPathSuccess='设置报警录像路径成功';
var str_AlarmPathFailC='设置失败,不能将系统目录设为录像路径!';
var str_AlarmPathFail='设置报警录像路径失败';
var str_motion_compensation="启动移动侦测补偿功能";
var str_reduce_motion_compensation="(减少光线突变情况下的误报警)";
var str_alarm_http_enable="HTTP报警通知";
var str_alarm_http_url="Http 网址";
var str_motion_number="(数字越大灵敏度越高)";
var str_ptz_number="* 值越小速度越快";

var str_video_rate='帧率';
...
var str_preset='启动后调用预置位';

//add ddns
var str_factory_ddns='厂家动态域名';
var str_factory_domain='厂家域名';
var str_third_ddns='第三方动态域名';

//add light
var str_light_config='指示灯设置';
var str_light_mode='指示灯模式';
var str_light_mode_1='联接网络时闪烁,没有连接到网络时熄灭';
var str_light_mode_2='联接网络时闪烁,没有连接到网络时用更慢的频率闪烁';
var str_light_mode_off='一直熄灭';

//preset
var str_setpreset="设置预置位";    
var str_usepreset="调用预置位";

//set2
var str_alarmaudio="报警开启声音";
var str_alarmrecord="报警开启录像";
...
var str_msn_ok='成功';
var str_msn_internal_error='系统内部错误';
var str_msn_fail_connect='无法连接服务器';
var str_msn_chat_error='与服务器对话错误';
var str_msn_tls_error = 'TLS会话失败';

//p2p
var str_p2p_config = 'P2P 设置';
var str_p2p_guid = 'GUID';
var str_save_confire = '设备需重启,确认设置?';

//ocx
var str_load_ocx = "下载ActiveX";
var str_ocx_notify = "警告信息显示如下:";
var str_ocx_notify_1 = "1. 您的电脑没有安装浏览视频控件.";
var str_ocx_notify_2 = "2. 您已经安装控件但版本不是最新,请重新安装控件.";
var str_ocx_please_onclick = "请点击";
var str_ocx_download = "下载控件";
var str_ocx_then_install = "然后安装控件,";
var str_ocx_refresh_page = "重新刷新网页,浏览视频.";
